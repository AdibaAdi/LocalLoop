function Hero({ onReportClick }) {
  return (
    <section className="relative overflow-hidden bg-gradient-to-b from-[#0D1F0F] to-[#132918] px-6 pb-24 pt-20">
      ...
      <div className="relative mx-auto max-w-4xl text-center">
        ...
        <p className="mx-auto mt-6 max-w-2xl text-lg text-civic-mist/85">Report local issues, rally your neighbors, and help city teams resolve what matters most.</p>

        <div className="relative mt-10 inline-flex">
          <span className="pointer-events-none absolute inset-0 rounded-full bg-civic-electric/60 blur-2xl animate-ping" />
          <span className="pointer-events-none absolute inset-0 rounded-full bg-[#86EFAC]/45 blur-xl animate-pulse" />
